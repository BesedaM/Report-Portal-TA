package com.epam.biaseda.reportportaltest.ui.selenide.validation.constants;
...
public class DashboardsValidationConstant {
    ...
    public static final String TABLE_HEADER_OWNER = "OWNER";
    public static final String TABLE_HEADER_SHARED = "SHARED";
    public static final String TABLE_HEADER_EDIT = "EDIT";
    public static final String TABLE_HEADER_DELETE = "DELETE";
}
