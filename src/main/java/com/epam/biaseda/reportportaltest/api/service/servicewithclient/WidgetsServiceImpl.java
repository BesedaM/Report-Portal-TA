...
public class WidgetsServiceImpl implements WidgetsService {
    ...
    @Override
    public CustomResponse postWidget(String projectName, WidgetEntity widget) {
        Map<String, String> pathSegments = new HashMap<>();
        pathSegments.put(PROJECT_NAME, projectName);
    ...
    @Override
    public CustomResponse putWidget(String projectName, int widgetId, WidgetEntity widget) {
        Map<String, String> pathSegments = new HashMap<>();
        pathSegments.put(PROJECT_NAME, projectName);
        pathSegments.put(WIDGET_ID, String.valueOf(widgetId));
